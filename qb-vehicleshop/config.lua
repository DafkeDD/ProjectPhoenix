...
-----------------------------------------------------------------------------
Config.UsingTarget = GetConvar('UseTarget', 'false') == 'true'  --- broken line make sure it matches qb management,
...
Config.Shops = {
    ['pdm'] = {
        ...
        ['spawn'] = vector3(-71.76, -1087.29, 26.68), -- Spawn location for STOCK BOUGHT (SAME AS PICK UP COORDS)
